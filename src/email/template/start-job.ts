...
const startJobEmail = (email, jobid) => {
																...
																<tr>
																	<td class="h1" style="padding: 5px 0 0 0">
																		...
																		<div>
																			<div>
																				<span
																					>You have submitted a new job.<br /><br /></span
																				><span>Your email: ${email}</span>
																				<br /><br /><span>Your job ID: ${jobid}</span>
																			</div>
																		</div>
																	</td>
																</tr>
															...
															<tbody>
																<tr>
																	...
																	>
																					...
																					>
																						<a
																							style="
																								...
																								border-color: #3498db;
																							"
																							href="${baseUrl}submit/multiome/${jobid}"
																							target="_blank"
																							rel="noopener"
																							>Click to Check your job status</a
																						>
																					</td>
																				</tr>
																			</tbody>
																		...
																		<span>&nbsp;</span
																		><span
																			>${baseUrl}submit/multiome/${jobid}<br
																		/></span>
																	</td>
																</tr>
															</tbody>
