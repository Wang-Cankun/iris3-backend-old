#!/bin/bash
wd=/var/www/nodejs/iris3-backend/plumber/20200416845281
exp_file=matrix.mtx.gz
label_file=1
gene_module_file=
jobid=20200416845281
motif_min_length=12
motif_max_length=12
perl /var/www/html/iris3/program/prepare_email1.pl $jobid
Rscript /var/www/html/iris3/program/genefilter.R $jobid $wd$exp_file , $label_file , No 0.8 10 5000 2 No
