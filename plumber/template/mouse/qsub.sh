...
wd=/var/www/html/iris3/data/20210207171144/
exp_file=Zeisel_expression.csv
label_file=Zeisel_index_label.csv
gene_module_file=
jobid=20210207171144
motif_min_length=12
motif_max_length=12
perl /var/www/html/iris3/program/prepare_email1.pl $jobid

Rscript /var/www/html/iris3/program/genefilter.R $jobid $wd$exp_file , $label_file , No 0.7 20 2000 2 No
echo gene_module_detection > running_status.txt

#unzip Zeisel_expression.csv
#cp $(basename "Zeisel_expression.csv" .zip).txt $wd$jobid\_filtered_expression.txt
